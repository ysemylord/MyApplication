 ...
 * Date: 13-10-10
 * Time: 上午9:25
 * 用于简化RadioGroup配上Fragment切换的创建过程
 */
public class FormatFragmentTabAdapter implements CompoundButton.OnCheckedChangeListener {
    private List<Fragment> fragments; // 一个tab页面对应一个Fragment
    private List<RadioButton> radiobuttons; // 用于切换tab
...
//                    fragment.onStart(); // 启动目标tab的onStart()
    ...
    public static class OnRgsExtraCheckedChangedListener {
        public void OnRgsExtraCheckedChanged(RadioButton radioButton, int index) {
