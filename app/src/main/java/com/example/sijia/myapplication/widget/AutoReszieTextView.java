 ...
 * @since Apr 4, 2011
 */
public class AutoReszieTextView extends TextView {
    ...
    public AutoReszieTextView(Context context) {
        this(context, null);
    }

    // Default constructor when inflating from XML file
    public AutoReszieTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    // Default constructor override
    public AutoReszieTextView(Context context, AttributeSet attrs, int defStyle) {
